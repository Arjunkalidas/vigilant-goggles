...
# Function to prepare text at prediction time
...
# Converting questions asked by the user to vectors
...
class SimpleDialogueManager(object):
    ...
    # Function to get most similar question's *post id* in the dataset,tag is the programming language
...
def main():
    token = '1039831056:AAHRJOHTV_gddp3i1rQbRjafJxpBF2KGv4k'
